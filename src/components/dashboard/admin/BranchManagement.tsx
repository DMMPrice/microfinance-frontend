...
export default function BranchManagement({ branches, regions, onUpdate }: BranchManagementProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {regions.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-10">
            <p className="text-muted-foreground">Create a region first to add branches</p>
          </CardContent>
        </Card>
      )}
    </div>
